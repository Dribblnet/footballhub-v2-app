...
import MobileProfileHeader from "../../../../components/responsive/MobileProfileHeader";
...
export default function PlayerProfileMobile(props) {
  const {
    player,
    navigate,
    filterPosition,
  ...
  return (
    <div style={{ width: "100%", maxWidth: "100vw", margin: "0 auto", padding: "15px", boxSizing: "border-box", overflowX: "hidden", minWidth: 0 }}>
      <header style={{ display: "flex", alignItems: "center", gap: "15px", marginBottom: "30px", flexWrap: "wrap" }}>
        <button onClick={() => navigate(-1)} style={{ background: "transparent", border: "none", color: "white", display: "flex", alignItems: "center", flexShrink: 0 }}>
          <ArrowLeft size={24} />
        </button>
        <h2 style={{ margin: 0, flex: "1 1 0", minWidth: 0, fontSize: "20px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>Player Profile</h2>
        <BrandLogo size="small" style={{ height: "24px", flexShrink: 0 }} clickable={false} />
      </header>
      ...
      {/* CONTACT (Private) */}
      {isOwnProfile && (
        <div className="glass-panel" style={{ padding: "15px", marginBottom: "15px", border: "1px solid rgba(59, 130, 246, 0.3)" }}>
          <h4 style={{ margin: "0 0 15px 0", color: "var(--primary)", fontSize: "16px" }}>Contact (Private)</h4>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", fontSize: "14px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", gap: "10px", flexWrap: "wrap" }}><span style={{ color: "var(--text-muted)", flexShrink: 0 }}>Email</span> <strong style={{ overflowWrap: "anywhere", wordBreak: "break-all", minWidth: 0, textAlign: "right" }}>{playerEmail || "Not added"}</strong></div>
            <div style={{ display: "flex", justifyContent: "space-between", gap: "10px", flexWrap: "wrap" }}><span style={{ color: "var(--text-muted)", flexShrink: 0 }}>Phone</span> <strong style={{ overflowWrap: "anywhere", wordBreak: "break-all", minWidth: 0, textAlign: "right" }}>{playerPhone || "Not added"}</strong></div>
          </div>
        </div>
      )}

      {/* LOCATION & ACCOUNT */}
      <div className="glass-panel" style={{ padding: "15px", marginBottom: "30px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(80px, 1fr))", gap: "15px", marginBottom: "30px" }}>
      ...
      <div className="glass-panel" style={{ display: "flex", flexWrap: "wrap", gap: "15px", padding: "12px", marginBottom: "30px" }}>
      ...
      <div className="glass-panel" style={{ position: "relative", padding: "15px", marginBottom: "30px", overflow: "hidden" }}>
        {/* CHEMISTRY DUO SECTION */}
        {bestDuo && (
          <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "12px", padding: "12px", marginBottom: "30px", display: "flex", justifyContent: "space-between", alignItems: "center", border: "1px solid rgba(255,255,255,0.1)" }}>
            <div>
