...
export default function SettingsMobile(props) {
  ...
  return (
    <div className="animate-fade-in" style={{ padding: "15px", width: "100%", margin: "0 auto", boxSizing: "border-box", overflowX: "hidden" }}>
      ...
      {/* ACCOUNT ACTIONS */}
      <div className="glass-panel" style={{ padding: "20px", marginBottom: "30px", border: "1px solid rgba(239, 68, 68, 0.2)" }}>
      ...
      {showDeleteConfirm && (
        <div style={{
          ...
          <div className="glass-panel animate-scale-in" style={{ padding: "30px 20px", maxWidth: "100%", width: "100%", textAlign: "center", border: "1px solid #ef4444", background: "#1e293b", boxShadow: "0 25px 50px rgba(0,0,0,0.5)" }}>
            <h2 style={{ margin: "0 0 15px 0", fontSize: "22px", fontWeight: "800", color: "#ef4444" }}>
              Delete Account
            </h2>
            ...
            <input
              ...
              style={{ width: "100%", marginBottom: "25px", border: "1px solid rgba(239, 68, 68, 0.3)", boxSizing: "border-box" }}
            />

            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <button className="btn-primary" onClick={handleDeleteAccount} style={{ width: "100%", background: "#ef4444", color: "white", border: "none" }}>Delete Permanently</button>
              <button className="btn-primary" onClick={() => { setShowDeleteConfirm(false); setDeleteConfirmationText(""); }} style={{ width: "100%", background: "transparent", border: "1px solid var(--border)", boxShadow: "none" }}>Cancel</button>
            </div>
          </div>
        </div>
      )}
