...
const Card = ({ children }) => (
  <div className="glass-panel" style={{ 
    width: "100%", padding: "30px 20px", textAlign: "center", 
    border: "none", 
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return <div style={{ color: "red", padding: "12px" }}>Something went wrong. {this.state.error?.toString()}</div>;
    }
    ...
    <div className="" style={{ 
      ...
      <Card>
        ...
        {step !== "AUTH_HOME" && step !== "NEW_PROFILE" && (
           ...
           }} style={{ position: "absolute", top: "20px", left: "20px", background: "transparent", border: "none", color: "#94a3b8", cursor: "pointer", display: "flex", alignItems: "center", gap: "5px", padding: 0 }} >
             <ArrowLeft size={24} />
           </button>
        )}

        <div style={{ marginBottom: "24px", display: "flex", justifyContent: "flex-start", marginTop: step !== "AUTH_HOME" ? "40px" : "60px" }}>
          <BrandLogo size="hero" style={{ filter: "drop-shadow(0 10px 30px rgba(59, 130, 246, 0.3))" }} clickable={false} />
        </div>
        
        <p style={{ margin: "0 0 32px 0", color: "#94a3b8", fontSize: "14px", fontWeight: "400" }}>
        ...
        {step === "AUTH_HOME" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%" }}>
            ...
            <button onClick={() => { setAuthMode("LOG_IN"); setStep("LOG_IN"); }} style={{ width: "100%", height: "56px", borderRadius: "14px", fontSize: "16px", fontWeight: "600", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "white", cursor: "pointer" }}>
              Log In
            </button>
          </div>
        )}
        ...
        {step === "LINK_PROMPT" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div style={{ padding: "12px", background: "rgba(255,255,255,0.03)", borderRadius: "14px", border: "1px solid rgba(255,255,255,0.05)", textAlign: "left" }}>
            ...
            <button onClick={() => setStep("LINK_GOOGLE")} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", width: "100%", height: "56px", border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.05)", color: "white", fontWeight: "600", cursor: "pointer", borderRadius: "14px" }}>
