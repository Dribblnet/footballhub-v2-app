...
export default function MarketplaceMobile(props) {
  const {
    navigate,
    requests,
    addRequest,
  ...
  return (
    <div style={{ width: "100%", margin: "0 auto", padding: "15px", boxSizing: "border-box", overflowX: "hidden" }}>
      ...
      {(() => {
        ...
        if (activeCount >= 3) {
          return (
            <div className="glass-panel" style={{ padding: "12px", marginBottom: "20px", background: "linear-gradient(90deg, rgba(239, 68, 68, 0.15), rgba(239, 68, 68, 0.05))", border: "1px solid rgba(239, 68, 68, 0.4)", borderRadius: "12px", borderLeft: "4px solid var(--danger)" }}>
      ...
      {!isCreating && (
        <div className="glass-panel" style={{ padding: "24px", marginBottom: "30px", display: "flex", flexDirection: "column", gap: "12px", background: "linear-gradient(145deg, rgba(37, 99, 235, 0.15) 0%, rgba(15, 23, 42, 0.95) 100%)", borderTop: "4px solid var(--primary)", borderBottom: "1px solid rgba(37,99,235,0.3)" }}>
      ...
      {deleteModalId && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.8)", backdropFilter: "blur(5px)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div className="glass-panel" style={{ padding: "15px", maxWidth: "400px", width: "90%", textAlign: "center", border: "1px solid rgba(239, 68, 68, 0.3)", boxShadow: "0 20px 50px rgba(0,0,0,0.5)" }}>
