...
export default function MatchViewDesktop(props) {
  const {
    id,
    navigate,
    match,
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: "flex", width: "100%", alignItems: "stretch", minHeight: "100px" }}>
          {/* Team A Side */}
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "flex-end", padding: "20px", background: "linear-gradient(90deg, rgba(37, 99, 235, 0.05), rgba(37, 99, 235, 0.2))", borderRight: "1px solid rgba(255,255,255,0.05)" }}>
             <div style={{ textAlign: "right" }}>
               <h3 style={{ margin: 0, fontSize: "28px", fontWeight: "900", textTransform: "uppercase" }}>{match.teamA.name}</h3>
               <p style={{ margin: 0, color: "var(--primary)", fontSize: "12px", fontWeight: "800", letterSpacing: "2px" }}>HOME</p>
             </div>
          </div>

          {/* Center Score Area */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "0 40px", background: "#05070a", borderBottom: "2px solid var(--primary)" }}>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: "64px", fontWeight: "900", color: "var(--primary)", lineHeight: 1, textShadow: "0 0 20px rgba(37,99,235,0.5)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  {(match.state === "PENALTY_SHOOTOUT" || (match.state === "FINISHED" && (match.penaltiesA?.length > 0 || match.penaltiesB?.length > 0))) && (
                    <span style={{ fontSize: "32px", color: "var(--warning)", marginLeft: "10px" }}>({match.penaltiesA?.filter(p => p.isGoal).length || 0})</span>
                  )}
                </div>
                <span style={{ margin: "0 20px", color: "white" }}>-</span>
                <div style={{ display: "flex", alignItems: "center" }}>
                  <span>{match.teamB.score}</span>
                  {(match.state === "PENALTY_SHOOTOUT" || (match.state === "FINISHED" && (match.penaltiesA?.length > 0 || match.penaltiesB?.length > 0))) && (
                    <span style={{ fontSize: "32px", color: "var(--warning)", marginLeft: "10px" }}>({match.penaltiesB?.filter(p => p.isGoal).length || 0})</span>
                  )}
                </div>
              </div>
            </div>
          ...
          {/* Team B Side */}
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "flex-start", padding: "20px", background: "linear-gradient(-90deg, rgba(245, 158, 11, 0.05), rgba(245, 158, 11, 0.2))", borderLeft: "1px solid rgba(255,255,255,0.05)" }}>
             <div style={{ textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center" }}>
               <h3 style={{ margin: 0, fontSize: "28px", fontWeight: "900", textTransform: "uppercase" }}>{match.teamB.name}</h3>
               <p style={{ margin: 0, color: "var(--warning)", fontSize: "12px", fontWeight: "800", letterSpacing: "2px" }}>AWAY</p>
             </div>
          </div>
        </div>
          ...
          {match.timeline.length === 0 ? (
            ...
            <div>
              {match.timeline.map(event => (
                <div key={event.id} style={{ display: "flex", alignItems: "center", gap: "20px", padding: "16px 0", borderBottom: "1px solid var(--border)" }}>
      ...
      {goalModal.isOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.95)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100 }}>
          <div className="glass-panel" style={{ width: "90%", maxWidth: "450px", padding: "30px", textAlign: "center", border: "1px solid var(--primary)", boxShadow: "0 20px 50px rgba(0,0,0,0.5)" }}>
            ...
            {goalModal.step === 4 && (
              <>
                 ...
                 <div style={{ background: "rgba(255,255,255,0.05)", border: "1px solid var(--border)", borderRadius: "12px", padding: "20px", marginBottom: "20px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      {editPlayerModal.isOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.95)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: "20px" }}>
          <div className="glass-panel" style={{ width: "100%", maxWidth: "450px", padding: "30px", textAlign: "center", display: "flex", flexDirection: "column", border: "1px solid var(--primary)", boxShadow: "0 20px 50px rgba(0,0,0,0.5)", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <div style={{ marginBottom: "25px", background: "rgba(255,255,255,0.03)", padding: "20px", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.05)" }}>
      ...
      {foulModal.isOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.95)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: "20px" }}>
          <div className="glass-panel" style={{ width: "100%", maxWidth: "450px", padding: "30px", textAlign: "center", border: "1px solid var(--primary)", boxShadow: "0 20px 50px rgba(0,0,0,0.5)" }}>
      ...
      {/* SAVE MODAL */}
      {saveModal.isOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.95)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: "20px" }}>
          <div className="glass-panel" style={{ width: "90%", maxWidth: "450px", padding: "30px", textAlign: "center", border: "1px solid var(--primary)", boxShadow: "0 20px 50px rgba(0,0,0,0.5)" }}>
            <div style={{ fontSize: "40px", marginBottom: "10px" }}>🧤</div>
      ...
      {penaltyWizard.isOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.95)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100 }}>
          <div className="glass-panel" style={{ width: "90%", maxWidth: "500px", padding: "30px", border: `2px solid ${penaltyWizard.team === "A" ? "var(--primary)" : "var(--warning)"}`, boxShadow: "0 20px 50px rgba(0,0,0,0.5)" }}>
      ...
      {undoModal && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.8)", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999 }}>
          <div style={{ background: "rgba(15,23,42,0.95)", border: "1px solid rgba(255,255,255,0.1)", padding: "30px", borderRadius: "20px", width: "90%", maxWidth: "380px", textAlign: "center", boxShadow: "0 20px 40px rgba(0,0,0,0.5)" }}>
